...
class Coupon(models.Model):
    ...
    order_id = fields.Many2one('account.move', 'Order Reference', readonly=True,
        help="The sales order from which coupon is generated")
    sales_order_id = fields.Many2one('account.move', 'Used in', readonly=True,
    ...
    def _check_coupon_code(self, order_date, partner_id, **kwargs):
        ...
        # Product requirement should not be checked if the coupon got generated by a promotion program (the requirement should have only be checked to generate the coupon)
            ...
            message = {'error': _("You don't have the required product quantities on your invoice. All the products should be recorded on the sales order. (Example: You need to have 3 T-shirts on your sales order if the promotion is 'Buy 2, Get 1 Free').")}
        else:
    ...
    def _get_default_template(self):
        ...
        if not default_template:
            return self.env.ref('aos_account_coupon.mail_template_invoice_coupon', False)
