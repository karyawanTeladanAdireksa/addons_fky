...
class StockRule(models.Model):
    ...
    def _get_stock_move_values(self, product_id, product_qty, product_uom, location_id, name, origin, company_id, values):
        ...
        move_values = {
            ...
            'product_uom_qty': (orderpoint.qty_pack * orderpoint.packaging_id.qty) if orderpoint else  qty_left,
            ...
            'orderpoint_id': orderpoint and values['orderpoint_id'].id,
            'product_packaging_id': orderpoint.packaging_id.id if orderpoint else values.get('product_packaging_id') and values['product_packaging_id'].id,
            'qty_pack':orderpoint.qty_pack if orderpoint else False,
