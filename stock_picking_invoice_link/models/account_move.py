...
class AccountMove(models.Model):
    ...
    picking_ref = fields.Char(string="DO Number",compute="_compute_picking_ids",store=True)
    ...
    def _compute_picking_ids(self):
        for invoice in self:
            ...
            invoice.picking_ref = ', '.join(invoice.picking_ids.filtered(lambda x:x.state == 'done').mapped('name'))
